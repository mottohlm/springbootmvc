...
public class AopConfig {
	...
	@Around("execution(*  com.learn.hlm.provider.*.get*(..)) || execution(*  com.learn.hlm.provider.*.find*(..))")
	...
	//清除缓存
	@Around("execution(*  com.learn.hlm.provider.*.delete*(..)) || execution(*  com.learn.hlm.provider.*.update*(..))")
